...
export const metadata: Metadata = {
  title: 'Gizlilik Politikası — Drop.tr',
  description: 'Drop.tr gizlilik politikası. Hiçbir veri toplanmaz, saklanmaz veya üçüncü taraflarla paylaşılmaz.',
};
    ...
    <>
      ...
      <div className="sub-page">
        ...
        <p className="page-desc">
          Drop.tr, gizliliğinizi en üst düzeyde korumak amacıyla tasarlanmıştır. Bu sayfa, verilerinizin nasıl işlendiğini (veya işlenmediğini) açıklamaktadır.
        </p>

        <div className="highlight-box">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
          <p><strong>Özet:</strong> Drop.tr hiçbir kişisel veri toplamaz, saklamaz, satmaz veya üçüncü taraflarla paylaşmaz. Dosyalarınız sunucularımıza asla yüklenmez.</p>
        </div>
        ...
        <div className="policy-section">
          ...
          <p>Drop.tr <strong>hiçbir kişisel veri toplamaz.</strong> Detaylı olarak:</p>
          <ul>
        ...
        <div className="policy-section">
          ...
          <p>Drop.tr <strong>hiçbir çerez kullanmaz.</strong> Ne birinci taraf ne de üçüncü taraf çerezleri oluşturulmaktadır. Tarayıcınızda Drop.tr&apos;ye ait herhangi bir çerez bulunmayacaktır.</p>
        </div>
        ...
        <div className="policy-section">
          ...
          <p>Drop.tr, tarayıcınızın yerel depolama alanını (localStorage, sessionStorage veya IndexedDB) <strong>kullanmaz.</strong> Sayfayı kapattığınızda cihazınızda Drop.tr&apos;ye ait hiçbir veri kalmaz.</p>
        </div>
        ...
        <div className="policy-section">
          ...
          <p>Drop.tr, Google Fonts dışında herhangi bir üçüncü taraf servisi kullanmaz. Reklam ağları, analitik araçları veya izleme pikselleri bulunmamaktadır.</p>
        </div>
        ...
        <div className="card" style={{ textAlign: 'center' }}>
          ...
          <a href="mailto:info@drop.tr" className="mail-link" style={{ marginTop: 12, display: 'inline-flex' }}>
